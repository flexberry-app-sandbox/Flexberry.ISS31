...
namespace IIS.ISS31
{
    ...
    public class ListSize : ICSSoft.STORMNET.DataObject
    {
        ...
        [NotNull()]
        public virtual IIS.ISS31.Size Size
        {
            get
            {
                ...
                IIS.ISS31.Size result = this.fSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListSizeE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListSizeE", typeof(IIS.ISS31.ListSize));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListSize : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ISS31.DetailArrayOfListSize members)

        // *** End programmer edit section *** (IIS.ISS31.DetailArrayOfListSize members)
        ...
        /// </summary>
        public DetailArrayOfListSize(IIS.ISS31.Support fSupport) : 
                base(typeof(ListSize), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.ISS31.ListSize this[int index]
        {
            get
            {
                return ((IIS.ISS31.ListSize)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ISS31.ListSize dataobject)
        {
