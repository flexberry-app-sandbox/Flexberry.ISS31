...
namespace IIS.ISS31
{
    ...
    public class ListInv : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS31.Investment fInvestment;
        
        private IIS.ISS31.Support fSupport;
        ...
        [NotNull()]
        public virtual IIS.ISS31.Investment Investment
        {
            get
            {
                ...
                IIS.ISS31.Investment result = this.fInvestment;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.ISS31.Support.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.ISS31.Support Support
        {
            get
            {
                ...
                IIS.ISS31.Support result = this.fSupport;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListInvE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListInvE", typeof(IIS.ISS31.ListInv));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListInv : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ISS31.DetailArrayOfListInv members)

        // *** End programmer edit section *** (IIS.ISS31.DetailArrayOfListInv members)
        ...
        /// </summary>
        public DetailArrayOfListInv(IIS.ISS31.Support fSupport) : 
                base(typeof(ListInv), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.ISS31.ListInv this[int index]
        {
            get
            {
                return ((IIS.ISS31.ListInv)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ISS31.ListInv dataobject)
        {
